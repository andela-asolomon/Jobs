...
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('jobfinders');'use strict';
// Use Applicaion configuration module to register a new module
...
//Setting up route
angular.module('jobfinders').config([
  '$stateProvider',
  function ($stateProvider) {
    // Jobfinders state routing
    $stateProvider.state('listJobfinders', {
      url: '/jobfinders',
      templateUrl: 'modules/jobfinders/views/list-jobfinders.client.view.html'
...
angular.module('jobfinders').controller('JobfindersController', [
  '$scope',
  '$rootScope',
  '$http',
  '$stateParams',
  ...
  function ($scope, $rootScope, $http, $stateParams, $location, Authentication, Jobfinders) {
    ...
    $scope.findOne = function () {
      $rootScope.jobfinder = Jobfinders.get({ jobfinderId: $stateParams.jobfinderId });
    };
  }
]);'use strict';
//Jobfinders service used to communicate Jobfinders REST endpoints
angular.module('jobfinders').factory('Jobfinders', [
  '$resource',
  function ($resource) {
    return $resource('jobfinders/:jobfinderId', { jobfinderId: '@_id' }, { update: { method: 'PUT' } });
  }
]);'use strict';
  ...
  function ($scope, $http, $location, Authentication) {
    ...
    $scope.signin = function () {
      $http.post('/auth/signin', $scope.credentials).success(function (response) {
        //If successful we assign the response to the global user model
        $scope.authentication.user = response;
        // console.log('Response: ' + $scope.authentication.user);
        //And redirect to the index page
        $location.path('/');
      }).error(function (response) {
        $scope.error = response.message;
...
angular.module('users').controller('SettingsController', [
  ...
  'Authentication',
  '$stateParams',
  function ($scope, $rootScope, $http, $location, Users, Authentication, $stateParams) {
    ...
    $scope.getJobId = function () {
      $scope.job = $rootScope.jobfinder;  // console.log($scope.job);
    };
